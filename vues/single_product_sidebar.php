...
<!-- Mirrored from htmlshopmart.justthemevalley.com/single_product_sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2019 18:29:28 GMT -->
<head>
<!-- Basic page needs -->
<meta charset="utf-8">
<!--[if IE]>
        ...
        <div class="col-main col-sm-9 col-xs-12">
          <div class="product-view-area">
            <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
              <div class="icon-sale-label sale-left">Sale</div>
              <div class="large-image"> <a href="images/products/product-3.jpg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img class="zoom-img" src="images/products/product-3.jpg" alt="products"> </a> </div>
        ...
        <aside class="right sidebar col-sm-3 col-xs-12">
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              <ul>
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.php" title="Sample Product" class="product-image"><img src="images/products/product-1.jpg" alt="Sample Product "></a></div>
                ...
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.php" title="Sample Product" class="product-image"><img src="images/products/product-2.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">
                ...
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.php" title="Sample Product" class="product-image"><img src="images/products/product-5.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">
                    <p class="product-name"> <a href="single_product.php">Consectetur utes anet adipisicing elit</a> </p>
