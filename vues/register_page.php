        ...
        <div class="account-login">
          ...
          <div class="col-md-6 col-sm-8">
            <div class="single-input p-bottom50 clearfix">
              <form action="traitement.php" method="POST" enctype="multipart">
                <div class="row">
                  ...
                  <div >
                     <div class="col-sm-6 "  style="display: flex;">
                        <select class="form-control" name="category_id">
                          <option>Choisir la catégorie de votre produit</option>
                          <option>women</option>
                          <option>&nbsp;&nbsp;&nbsp;Chair </option>
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="input-text">
                      <input type="text" name="address" class="form-control" placeholder="Champs lexical de l'article: Tunique,Tenue homme, vêtements hommes...">
                    </div>
                  </div>
                  <div class="col-xs-12">
                    <br>
                    <div class="submit-text">
                      <button class="button"><i class="fa fa-plus"></i>&nbsp; <span>Ajouter ce produit</span></button>
                    </div>
                  </div>
                </div>
              </form>
