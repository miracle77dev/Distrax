          ...
          <div class="product-view-area">
            <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
              ...
              <div class="large-image">
               <a href="test.jpeg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img class="zoom-img" src="test.jpeg" alt="<?=$Produit->NomProduit?>"> </a>
                </div>
              <div class="flexslider flexslider-thumb">
                <ul class="previews-list slides">
                  <li><a href='test.jpeg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'admin/upload/<?=$Produit->DeuxiemeImage?>' "><img src="test.jpeg" alt = "<?= $Produit->NomProduit?>"/></a>
                  </li>
                  <li>
            ...
            <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">
              ...
              <div class="price-box">
                <p class="special-price"> <span class="price-label">Prix promo</span> <span class="price"><?= $Produit->PrixProduit?> Fcfa</span> </p>
                <p class="old-price"> <span class="price-label">Prix:</span> <span class="price"><?= $Produit->PrixProduit?> Fcfa</span> </p>
              </div>
              <div class="ratings">
              ...
              <div class="product-variation">
                <form action="#" method="post">
                  ...
                  <button class="button pro-add-to-cart" title="ajouter au panier" type="button"><span><i class="fa fa-shopping-basket"></i><a href="ajouter.php?id=<?=$Produit->id?>">ajouter au panier</a></span></button>
                </form>
              </div>
            ...
            <div class="slider-items-products">
              <div id="related-product-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col4 fadeInUp">
                  <?php $s=similaire($Produit->sous_categorie); 
                  foreach ($s as $value):?>
          ...
          <div class="slider-items-products">
            <div id="upsell-product-slider" class="product-flexslider hidden-buttons">
              <div class="slider-items slider-width-col4">
                 <?php $v=plusVendu($Produit->categorie); 
                  foreach ($v as $value):?>
                <div class="product-item">
                  <div class="item-inner">
                    <div class="product-thumbnail">
...
<script type="text/javascript" src="vues/js/jquery.magnifying-zoom.js"></script>
</body>
</html>
