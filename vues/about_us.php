      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li><strong>A propos de nous</strong></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="main container">
     ...
     <div class="about-page">
        <div class="col-xs-12 col-sm-6"> 
          ...
          <h1>Bienvenue au <span class="text_color">KeneShy</span></h1>
          ...
          <div class="single-img-add sidebar-add-slider">
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active"> <img src="vues/images/miraculeux.jpg" alt="slide1"> </div>
                <div class="item"> <img src="vues/images/jl.jpg" alt="slide2"> </div>
                <div class="item"> <img src="vues/images/jldc.jpg" alt="slide3"> </div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="wow bounceInUp" data-wow-delay="0.2s">
            <div class="team">
              <div class="inner">
                <div class="avatar"><img src="vues/images/dc.png" alt="" class="img-responsive" /></div>
                <h5>Miraculeux</h5>
                <p class="subtitle">Webmaster/Programmeur</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-xs-6 col-sm-3 col-md-3">
          <div class="wow bounceInUp" data-wow-delay="0.8s">
            <div class="team">
              <div class="inner">
                <div class="avatar"><img src="vues/images/jl.jpg" alt="jl" class="img-responsive" /></div>
                <h5>ADOUKO Jean louis</h5>
                <p class="subtitle">Webmaster/programmer</p>
              </div>
            </div>
          </div>
        </div>
