      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class=""> <a title="Go to Home Page" href="nouveau.php">Smartphone</a><span>&raquo;</span></li>
        ...
        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
            ...
            <div class="slider-items-products">
              <div id="category-desc-slider" class="product-flexslider hidden-buttons">
                <div class="slider-items slider-width-col1 owl-carousel owl-Template"> 
                  ...
                  <!-- Item -->
                  <div class="item"> <a href="#x"><img alt="HTML template" src="vues/images/cat-slider-img1.jpg"></a>
                  ...
                  <!-- Item -->
                  <div class="item"> <a href="#x"><img alt="HTML template" src="vues/images/cat-slider-img2.jpg"></a> </div>
          ...
          <div class="shop-inner">
            ...
            <div class="toolbar">
              <div class="view-mode">
                <ul>
                  <li> <a href="nouveau.php"> <i class="fa fa-th-large"></i> </a> </li>
                  <li class="active"> <a href="nouveau-list.php"> <i class="fa fa-th-list"></i> </a> </li>
                </ul>
              </div>
              <div class="sorter">
                <div class="short-by">
              ...
              <ul class="products-list" id="products-list">
                <li class="item ">
                  <div class="product-img">
                    ...
                    <a href="single_product.php" title="Ipsums Dolors Untra">
                    <figure> <img class="small-image" src="vues/images/products/product-1.jpg" alt="Ipsums Dolors Untra"></figure>
                    </a> </div>
                  <div class="product-shop">
                    ...
                    <div class="actions">
                      ...
                      <ul>
                        <li> <a href="wishlist.php"> <i class="fa fa-heart-o"></i><span> Add to Wishlist</span> </a> </li>
                        <li> <a href="compare.php"> <i class="fa fa-link"></i><span> Add to Compare</span> </a> </li>
                      </ul>
                    </div>
                  </div>
                </li>
                <li class="item ">
                  <div class="product-img"> <a href="single_product.php" title="Ipsums Dolors Untra">
                    <figure> <img class="small-image" src="vues/images/products/product-2.jpg" alt="Ipsums Dolors Untra"></figure>
                    </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="single_product.php" title="Ipsums Dolors Untra">Ipsums Dolors Untra</a></h2>
                    <div class="ratings">
                    ...
                    <div class="desc std">
                      ...
                      <p> Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere libero eu augue condimentum rhoncus. <a class="link-learn" title="Learn More" href="single_product.php">Learn More</a> </p>
                    </div>
                    <div class="actions">
                      <button class="button cart-button" title="Add to Cart" type="button"><i class="fa fa-shopping-basket"></i><span>Add to Cart</span></button>
                      <ul>
                ...
                <li class="item ">
                  <div class="product-img">
                    ...
                    <a href="single_product.php" title="Ipsums Dolors Untra">
                    <figure> <img class="small-image" src="vues/images/products/product-3.jpg" alt="Ipsums Dolors Untra"></figure>
                    </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="single_product.php" title="Ipsums Dolors Untra">Ipsums Dolors Untra</a></h2>
                    <div class="ratings">
                    ...
                    <div class="desc std">Donec Vitae Hendrerit Arcu, Sit Amet Faucibus Nisl. Cras Pretium Arcu Ex. Aenean Posuere Libero Eu Augue Condimentum Rhoncus. Praesent Ornare Tortor Donec Vitae Hendrerit Arcu, Sit Amet Faucibus Nisl. Praesent ornare tortor Aenean posuere libero eu augue condimentum rhoncus. <a class="link-learn" title="Learn More" href="single_product.php">Learn More</a> </div>
                    <div class="actions">
                      <button class="button cart-button" title="Add to Cart" type="button"><i class="fa fa-shopping-basket"></i><span>Add to Cart</span></button>
                      <ul>
                        <li> <a href="wishlist.php"> <i class="fa fa-heart-o"></i><span> Add to Wishlist</span> </a> </li>
                ...
                <li class="item ">
                  <div class="product-img"> <a href="single_product.php" title="Ipsums Dolors Untra">
                    <figure> <img class="small-image" src="vues/images/products/product-4.jpg" alt="Ipsums Dolors Untra"></figure>
                    </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="single_product.php" title="Ipsums Dolors Untra">Ipsums Dolors Untra</a></h2>
                    <div class="ratings">
                    ...
                    <div class="desc std">Aliquam quis dui at orci mattis tincidunt et vel risus. In odio quam, vestibulum non faucibus sit amet, posuere id lectus. In odio quam, vestibulum non faucibus sit amet, posuere id lectus. Nulla nunc felis, condimentum ac congue blandit, mattis a mauris. <a class="link-learn" title="Learn More" href="single_product.php">Learn More</a> </div>
                    <div class="actions">
                      <button class="button cart-button" title="Add to Cart" type="button"><i class="fa fa-shopping-basket"></i><span>Add to Cart</span></button>
                      <ul>
                        <li> <a href="wishlist.php"> <i class="fa fa-heart-o"></i><span> Add to Wishlist</span> </a> </li>
                ...
                <li class="item ">
                  <div class="product-img"> <a href="single_product.php" title="Ipsums Dolors Untra">
                    <figure> <img class="small-image" src="vues/images/products/product-5.jpg" alt="Ipsums Dolors Untra"></figure>
                    </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="single_product.php" title="Ipsums Dolors Untra">Ipsums Dolors Untra</a></h2>
                    <div class="ratings">
                    ...
                    <div class="desc std">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. <a class="link-learn" title="Learn More" href="single_product.php">Learn More</a> </div>
                    <div class="actions">
                      <button class="button cart-button" title="Add to Cart" type="button"><i class="fa fa-shopping-basket"></i><span>Add to Cart</span></button>
                      <ul>
                        <li> <a href="wishlist.php"> <i class="fa fa-heart-o"></i><span> Add to Wishlist</span> </a> </li>
                ...
                <li class="item ">
                  <div class="product-img"> <a href="single_product.php" title="Ipsums Dolors Untra">
                    <figure> <img class="small-image" src="vues/images/products/product-6.jpg" alt="Ipsums Dolors Untra"></figure>
                    </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="single_product.php" title="Ipsums Dolors Untra">Ipsums Dolors Untra</a></h2>
                    <div class="ratings">
                ...
                <li class="item ">
                  <div class="product-img"> <a href="single_product.php" title="Ipsums Dolors Untra">
                    <figure> <img class="small-image" src="vues/images/products/product-8.jpg" alt="Ipsums Dolors Untra"></figure>
                    </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="single_product.php" title="Ipsums Dolors Untra">Ipsums Dolors Untra</a></h2>
                    <div class="ratings">
                ...
                <li class="item ">
                  ...
                  <div class="product-shop">
                    ...
                    <div class="desc std">Morbi accumsan ipsum velit. Nam
                      ...
                      erat conuat auctor eu in elitlass aptent taciti sociosqu ad litora. Morbi pretium sed velit in tempus. Nullam nec aliquam lorem. <a class="link-learn" title="Learn More" href="single_product.php">Learn More</a> </div>
                    <div class="actions">
                      <button class="button cart-button" title="Add to Cart" type="button"><i class="fa fa-shopping-basket"></i><span>Add to Cart</span></button>
                      <ul>
                        <li> <a href="wishlist.php"> <i class="fa fa-heart-o"></i><span> Add to Wishlist</span> </a> </li>
                ...
                <li class="item ">
                  <div class="product-img"> <a href="single_product.php" title="Ipsums Dolors Untra">
                    <figure> <img class="small-image" src="vues/images/products/product-9.jpg" alt="Ipsums Dolors Untra"></figure>
                    </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="single_product.php" title="Ipsums Dolors Untra">Ipsums Dolors Untra</a></h2>
                    <div class="ratings">
                    ...
                    <div class="desc std">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ultrices sollicitudin justo, eget mollis justo semper vel. Duis tempor eget leo eget pretium. <a class="link-learn" title="Learn More" href="single_product.php">Learn More</a> </div>
                    <div class="actions">
                      <button class="button cart-button" title="Add to Cart" type="button"><i class="fa fa-shopping-basket"></i><span>Add to Cart</span></button>
                      <ul>
                        <li> <a href="wishlist.php"> <i class="fa fa-heart-o"></i><span> Add to Wishlist</span> </a> </li>
        ...
        <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
          ...
          <div class="block sidebar-cart">
            ...
            <div class="block-content">
              ...
              <ul>
                <li class="item"> <a href="shopping_cart.php" title="Sample Product" class="product-image"><img src="vues/images/products/product-8.jpg" alt="Sample Product "></a>
                ...
                <li class="item last"> <a href="#" title="Sample Product" class="product-image"><img src="vues/images/products/product-8.jpg" alt="Sample Product"></a>
                  <div class="product-details">
                    <div class="access"> <a href="#" title="Remove This Item" class="remove-cart"><i class="icon-close"></i></a></div>
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              <ul>
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.php" title="Sample Product" class="product-image"><img src="vues/images/products/product-1.jpg" alt="Sample Product "></a></div>
                ...
                <li class="item">
                  <div class="products-block-left"> <a href="single_product.php" title="Sample Product" class="product-image"><img src="vues/images/products/product-2.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">
          ...
          <div class="offer-banner"><img src="vues/images/offer-banner.jpg" alt="banner"></div>
        </aside>
      </div>
    </div>
  </div>
